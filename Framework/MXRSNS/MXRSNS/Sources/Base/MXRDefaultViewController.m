...
//    [button setImage:[UIImage imageNamedUseTintColor:@"icon_gray_left_arrow_pre"] forState:UIControlStateHighlighted];
    ...
    UIImage *backIndicator = [[UIImage imageWithContentsOfFile:[[NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]] pathForResource:@"MXRBase" ofType:@"bundle"]] pathForResource:@"icon_white_left_arrow@3x" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
...
//        backgroundImage = [UIImage imageNamedRenderingModeAlwaysOriginal:@"icon_white_left_arrow"];
    backgroundImage = [[UIImage imageWithContentsOfFile:[[NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]] pathForResource:@"MXRBase" ofType:@"bundle"]] pathForResource:@"icon_white_left_arrow@3x" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        /*V5.8.0 modified by MT.X*/
...
//    return  [self createDefaultBackButtonWithTitle:title backgroundImage:[UIImage imageNamed:@"icon_gray_left_arrow"]];
    ...
    return [self createDefaultBackButtonWithTitle:title backgroundImage:[[UIImage imageWithContentsOfFile:[[NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]] pathForResource:@"MXRBase" ofType:@"bundle"]] pathForResource:@"icon_white_left_arrow@3x" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    /*V5.8.0 modified by MT.X*/
}
