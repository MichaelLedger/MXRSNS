...
+ (UIImage *)imageWithName:(NSString *)imageName
{
    ...
    //test
    if (!image) {
        image =  [UIImage imageWithContentsOfFile:[[NSBundle bundleForClass:[self class]] pathForResource:desImageName ofType:@"png"]];
    }
    if (!image) {
        image =  [UIImage imageWithContentsOfFile:[[NSBundle bundleForClass:[self class]] pathForResource:[desImageName stringByAppendingString:@"@2x"] ofType:@"png"]];
    }
    if (!image) {
        image =  [UIImage imageWithContentsOfFile:[[NSBundle bundleForClass:[self class]] pathForResource:[desImageName stringByAppendingString:@"@3x"] ofType:@"png"]];
    }
