...
-(void)dynamicCommentHasDelete {
    MXRDynamicHasDeleteView *hasDeleteDynamicView = [[[NSBundle bundleForClass:[self class]] loadNibNamed:@"MXRDynamicHasDeleteView" owner:nil options:nil] lastObject];
...
-(void)addTableView{
    ...
    [self.tabView registerNib:[UINib nibWithNibName:mxrBookSNSTableViewCell bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSTableViewCell];
    [self.tabView registerNib:[UINib nibWithNibName:mxrBookSNSForwardTableViewCell  bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSForwardTableViewCell];
    [self.tabView registerNib:[UINib nibWithNibName:mxrBookSNSDeleteForwardTableViewCell  bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSDeleteForwardTableViewCell];
    [self.tabView registerNib:[UINib nibWithNibName:MXRBookSNSDetailXIB bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:Indentifier];
...
-(MXRSNSCommentView *)commentView {
    if (!_commentView) {
        _commentView = [[NSBundle bundleForClass:[self class]] loadNibNamed:@"MXRSNSCommentView" owner:self options:nil].lastObject;
...
-(void)addFootView{
    self.footView = [[[NSBundle bundleForClass:[self class]] loadNibNamed:FootViewXIB owner:nil options:nil] lastObject];
