...
-(instancetype)initWithMXRSNSShareModel:(MXRSNSShareModel *)momentModel {
    if (self = [super initWithNibName:@"MXRSNSPraiseDetailViewController" bundle:[NSBundle bundleForClass:[self class]]]) {
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"MXRSNSPraiseListTableViewCell" bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:CellIndentifier];
}
