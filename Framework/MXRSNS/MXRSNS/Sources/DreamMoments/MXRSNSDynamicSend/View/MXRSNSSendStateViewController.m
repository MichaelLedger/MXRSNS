...
-(instancetype)init
{
    if (self = [super initWithNibName:@"MXRSNSSendStateViewController" bundle:[NSBundle bundleForClass:[self class]]]) {
...
-(void)setupImageDisplayCollectionView{
    ...
    [self.selectImageCollection registerNib:[UINib nibWithNibName:@"MXRHaveDoneSelectImageCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:MXRHaveDoneSelectImageCellID];
