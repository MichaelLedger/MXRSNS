...
-(UICollectionView *)collectionView{
    ...
    if (!_collectionView) {
        ...
        [_collectionView registerNib:[UINib nibWithNibName:mxrBookSNSHeadTopicCollectionViewCell bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:mxrBookSNSHeadTopicCollectionViewCell];
    }
