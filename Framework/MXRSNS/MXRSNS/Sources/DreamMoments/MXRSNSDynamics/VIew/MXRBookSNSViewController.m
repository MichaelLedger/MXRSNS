...
-(void)setupbookSNSTableView{
    ...
    [self.bookSNSTableView registerNib:[UINib nibWithNibName:mxrBookSNSTableViewCell bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSTableViewCell];
    [self.bookSNSTableView registerNib:[UINib nibWithNibName:mxrBookSNSForwardTableViewCell  bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSForwardTableViewCell];
    [self.bookSNSTableView registerNib:[UINib nibWithNibName:mxrBookSNSDeleteForwardTableViewCell  bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSDeleteForwardTableViewCell];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([MXRBookSNSModelProxy getInstance].bookSNSMomentsArray.count == 0) {
        ...
        cell.imageView.image = MXRIMAGE(@"icon_cell_BookSNS_placeholder_disable@2x");
