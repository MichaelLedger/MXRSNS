...
-(UITableView*)tableView
{
    if (!_tableView)
    {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"MXRSearchTopicTableViewCell" bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:cellIdentifier];
    }
    return _tableView;
}
