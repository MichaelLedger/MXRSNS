...
-(instancetype)initWithMXRTopicModelID:(NSString *)topicID{
    self = [super initWithNibName:@"MXRTopicMainViewController" bundle:[NSBundle bundleForClass:[self class]]];
    if (self) {
       p_topicID = topicID;
    }
    return self;
...
//    self.navigationItem.rightBarButtonItems = @[negativeSpacer,self.shareBtn];
    ...
    [self.e_tableView registerNib:[UINib nibWithNibName:mxrBookSNSTableViewCell bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSTableViewCell];
    [self.e_tableView registerNib:[UINib nibWithNibName:mxrBookSNSForwardTableViewCell  bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSForwardTableViewCell];
    [self.e_tableView registerNib:[UINib nibWithNibName:mxrBookSNSDeleteForwardTableViewCell  bundle:[NSBundle bundleForClass:[self class]]] forCellReuseIdentifier:mxrBookSNSDeleteForwardTableViewCell];
