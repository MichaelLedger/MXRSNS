...
//        [[MXRSettingTimerManager sharedInstance] resumeTipsTimer];
        ...
        MXRPKResultViewController *vc = [[MXRPKResultViewController alloc] initWithNibName:@"MXRPKResultViewController" bundle:[NSBundle bundleForClass:[self class]]];
