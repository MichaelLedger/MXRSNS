...
- (void)UIGlobals
{
   ...
   self.collecitonViewFlowLayout.sectionInset = UIEdgeInsetsMake(10, 10, 10, 10); self.collecitonViewFlowLayout.itemSize = CGSizeMake(SCREEN_WIDTH_DEVICE - self.collecitonViewFlowLayout.sectionInset.left - self.collecitonViewFlowLayout.sectionInset.right, 60);
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"MXRPKNormalHeaderView" bundle:[NSBundle bundleForClass:[self class]]] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"MXRPKNormalHeaderView"];
    [self.collectionView registerNib:[UINib nibWithNibName:@"MXRPKAnswerOptionCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:@"MXRPKAnswerOptionCell"];
    [self.collectionView registerNib:[UINib nibWithNibName:@"MXRPKImageOptionCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:@"MXRPKImageOptionCell"];
    [self.collectionView registerNib:[UINib nibWithNibName:@"MXRPKNormalFooterView" bundle:[NSBundle bundleForClass:[self class]]] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"MXRPKNormalFooterView"];
...
- (void)tempCollectionRegister
{
    ...
    [self.collecitonTempView registerNib:[UINib nibWithNibName:@"MXRPKNormalHeaderView" bundle:[NSBundle bundleForClass:[self class]]] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"MXRPKNormalHeaderView"];
    [self.collecitonTempView registerNib:[UINib nibWithNibName:@"MXRPKAnswerOptionCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:@"MXRPKAnswerOptionCell"];
    [self.collecitonTempView registerNib:[UINib nibWithNibName:@"MXRPKImageOptionCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:@"MXRPKImageOptionCell"];
    [self.collecitonTempView registerNib:[UINib nibWithNibName:@"MXRPKNormalFooterView" bundle:[NSBundle bundleForClass:[self class]]] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"MXRPKNormalFooterView"];
}
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section
{
    ...
    MXRPKNormalHeaderView *headerView = [[NSBundle bundleForClass:[self class]] loadNibNamed:@"MXRPKNormalHeaderView" owner:nil options:nil][0];
    headerView.questionContentLabel.preferredMaxLayoutWidth = SCREEN_WIDTH_DEVICE - self.collecitonViewFlowLayout.sectionInset.left - self.collecitonViewFlowLayout.sectionInset.right - 80;
