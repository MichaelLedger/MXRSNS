...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"MXRPKMedalCollectionViewCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:Identifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.callback = ^(MXRPKMedalDetailModel *pkMedalDetailModel) {
        ...
        MXRPKMedalDetailView *pkMedalDetailView = [[NSBundle bundleForClass:[self class]] loadNibNamed:@"MXRPKMedalDetailView" owner:nil options:nil].lastObject;
