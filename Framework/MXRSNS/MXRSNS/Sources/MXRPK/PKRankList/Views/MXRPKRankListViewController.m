...
- (void)viewDidLoad {
    ...
    [self.collectioniew registerNib:[UINib nibWithNibName:@"MXRPKRankFirstCollectionViewCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:@"MXRPKRankFirstCollectionViewCell"];
    [self.collectioniew registerNib:[UINib nibWithNibName:@"MXRPKRankListCollectionViewCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:@"MXRPKRankListCollectionViewCell"];
    [self.collectioniew registerNib:[UINib nibWithNibName:@"MXRPKRankListEmptyCollectionCell" bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:@"MXRPKRankListEmptyCollectionCell"];
    [self.collectioniew registerNib:[UINib nibWithNibName:@"MXRPKRankListHeaderReusableView" bundle:[NSBundle bundleForClass:[self class]]] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"MXRPKRankListHeaderReusableView"];
    [self setUpUI];
    [self loadData];
}
