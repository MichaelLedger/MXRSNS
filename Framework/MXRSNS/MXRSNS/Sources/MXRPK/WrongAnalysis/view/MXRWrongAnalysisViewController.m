...
- (void)setupCollectionView {
    [_collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([MXRWrongAnalysisAnswerTextCell class]) bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:MXRWrongAnalysisAnswerTextCellIdentifier];
    [_collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([MXRWrongAnalysisAnswerImageCell class]) bundle:[NSBundle bundleForClass:[self class]]] forCellWithReuseIdentifier:MXRWrongAnalysisAnswerImageCellIdentifier];
}
