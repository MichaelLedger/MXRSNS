...
+(instancetype)pkHomeViewController{
     UIStoryboard *sb = [UIStoryboard storyboardWithName:PK_STORYBOARD_NAME bundle:nil];
...
#pragma mark -
-(void)setup{
    [self.collectionView registerNib:[UINib nibWithNibName:@"MXRPKHomeNewHeaderView" bundle:[NSBundle mainBundle]] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:MXR_PK_HOME_HEADER_IDENTIFIER];
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        view.jumpToPropBlock = ^{
            MXRPKPropShopViewController *propVc = [[MXRPKPropShopViewController alloc] init];
...
-(void)goToPKQuestionWithMXRPKUserInfoModel:(MXRPKUserInfoModel *)pkUserInfoModel{
    ...
    MXRPKAnswerVC *pkAnswerVC = [[MXRPKAnswerVC alloc] init];
