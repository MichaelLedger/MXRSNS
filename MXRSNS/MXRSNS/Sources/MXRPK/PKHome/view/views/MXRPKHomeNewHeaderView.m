...
- (void)awakeFromNib {
    ...
    [_medalCollectionView registerNib:[UINib nibWithNibName:@"MXRPKHomeMedalCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:cellIdentifier];
    [self setupUI];
...
-(void)setupUI {
    ...
    self.radarBgIv.image = MXRIMAGE(@"bg_abilitytomap");
