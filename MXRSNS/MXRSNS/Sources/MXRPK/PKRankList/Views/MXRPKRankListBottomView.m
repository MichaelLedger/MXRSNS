...
+ (instancetype)instancePKRankListView {
    ...
    return [[[NSBundle mainBundle] loadNibNamed:@"MXRPKRankListBottomView" owner:self options:nil]lastObject];
}

- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self = [[[NSBundle mainBundle] loadNibNamed:@"MXRPKRankListBottomView" owner:self options:nil]lastObject];
        myframe = frame;
    }
    return self ;
}
