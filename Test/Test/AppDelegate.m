...
@import MXRSNS.MXRBOOKSNSViewController;
@import MXRSNS.MXRNavigationViewController;
...
//    MXRBookSNSViewController *sns = [[MXRBookSNSViewController alloc] init];
    MXRBookSNSViewController *sns = [[MXRBookSNSViewController alloc] initWithNibName:@"MXRBookSNSViewController" bundle:[NSBundle bundleForClass:[MXRBookSNSViewController class]]];
    sns.hideTabbar = YES;
...
- (void)setNavigationBarAppearence {
    ...
    [[UINavigationBar appearance] setBackgroundImage:[self imageWithColor:MXRCOLOR_MAIN] forBarMetrics:UIBarMetricsDefault];//会造成视图错位导航栏的高度
}
